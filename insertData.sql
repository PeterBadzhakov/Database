...
insert into RENTS
values (2, 0, 'OUTATIME',1576972800 - 1576713600, 20000, 1576713600, 1576972800, 10000),
       (0, 1, 'B00M', 1583712000 - 1583020800, 24000, 1583020800, 1583712000, 3000),
       (4, 5, 'AB32145BR', 1592438400 - 1591401600, 120000, 1591401600, 1592438400, 10001),
       (1, 5, 'AB32145BR', 1581292800 - 1580601600, 90000, 1580601600, 1581292800, 10000),
       (3, 4, 'US32410SR', 1585353600 - 1584144000, 100000, 1584144000, 1585353600, 8000),
       (5, 3, 'AA22221MM', 1592611200 - 1592179200, 30000, 1592179200, 1592611200, 10000);
